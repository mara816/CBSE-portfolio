...
/*         for (IPostEntityProcessingService postEntityProcessorService : getPostEntityProcessingServices()) {
    ...
    private Collection<? extends IGamePluginService> getPluginServices() {
        ...
        pluginList.add(enemyIGamePluginService());
        pluginList.add(playerIGamePluginService());
           pluginList.add(asteroidIGamePluginService());
        return pluginList;
    }

    private Collection<? extends IEntityProcessingService> getEntityProcessingServices() {
        ArrayList<IEntityProcessingService> entityList = new ArrayList<>();
        entityList.add(enemyIEntityProcessingService());
        entityList.add(playerIEntityProcessingService());
              entityList.add(asteroidIEntityProcessingService());
        return entityList;
    }
}
